...
<div class="am-content">
  <div class="main-content">
        ...
        <form class="form-horizontal" method="post" action="{{ route('bible.store') }}">
            ...
            <div id="basicinfo" class="collapse in">
              <div class="panel-body" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="email" class="form-control"  style="border-radius:10px " name="email" placeholder="Email" value="{{ old('email') }}">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                     ...
                     <input type="text" class="form-control" style="border-radius:10px " name="principal" id="principal" placeholder="Founder" value="{{ old('principal') }}">
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6 col-sm-offset-1">
                      <input type="text" class="form-control" name="enrollment" id="enrollment">
