...
.info-tiles .tiles-body .easypiechart .percent {
    ...
    <div class="row">
         <div class="col-md-3">
          ...
          <div class="tiles-heading">
              <div class="pull-left">Denominations</div>
          ...
          <div class="tiles-body">
              <div class="text-center">{{$dcount}}</div>
          </div>
          ...
          <div class="tiles-heading">
              <div class="pull-left">BibleSchools</div>
              <div class="pull-right">
          ...
          <div class="tiles-body">
              <div class="text-center">{{$bcount}}</div>
          </div>
        ...
        <div class="col-md-3">
          <a class="info-tiles tiles-inverse has-footer" href="#">
            <div class="tiles-heading">
              <div class="pull-left">Ministers</div>
              <div class="pull-right">
          ...
          <div class="tiles-body">
              <div class="text-center">{{$ministers}}</div>
          </div>
        ...
        <div class="col-md-3">
          ...
          <div class="tiles-heading">
              <div class="pull-left">Para Churches</div>
              <div class="pull-right">
          ...
          <div class="tiles-body">
              <div class="text-center">{{$pcount}}</div>
          </div>
  ...
  <div class="panel-heading">Ministers by Gender</div>
  <div class="panel-body"><div id="donut-example" style="height: 200px;"></div>
        <div id="legend" class="donut-legend"></div></div>
</div>
   ...
   <div class="panel panel-default">
  <div class="panel-heading">Denomination by Commission</div>
  <div class="panel-body"><div id="donut-commission" style="height: 200px;"></div>
        <div id="legend" class="donut-legend"></div></div>
</div>
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
  <div class="panel-heading">Subscriptions by Status</div>
  <div class="panel-body"><div id="donut-status" style="height: 200px;"></div>
        <div id="legend" class="donut-status"></div></div>
</div>
   ...
   <div class="row">
       ...
       <div class="col-md-12">
           <h3 class="title">Ministers by Province</h3>
...
<script type="text/javascript">
    var ObjectM = <?php echo $genderM; ?>;
    var ObjectF = <?php echo $genderF; ?>;
...
<script type="text/javascript">
  ...
  data: [
    {label: "Male", value: ObjectM},
    {label: "Female", value: ObjectF},
  ...
  data: [
    {label: "Recieved", value: 20},
    {label: "No Recieved", value: 10},
