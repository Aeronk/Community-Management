    ...
    <div class="main-content">
		<div class="container">
			<div class="row">
				...
				<a href="{{ route('contribution.index') }}" class="btn btn-sm btn-primary"><i class="fa fa-hand"></i>Back
					to listing</a><br>
			...
			<div class="row">
				<table class="table table-striped table-bordered">
					...
					<tr>
						<td><b style="font-family:serif;font-size:15px">Amount</b></td>
						<td>200.00</td>
					</tr>
					<tr>
						<td><b style="font-family:serif;font-size:15px">Date Income</b></td>
						<td>2018-04-15</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>2018-04-16 03:49:20</td>
					</tr>
					<tr>
						<td><b style="font-family:serif;font-size:15px">Administrator</b></td>
						<td>Mashingaidze</td>
					</tr>
					<tr>
