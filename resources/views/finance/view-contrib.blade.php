					...
					<tbody>
						...
						<tr>
							...
							<td>
		                         ...
		                         href="{{ route('individualcontribution.show', $contribution->id) }}" class="btn btn-danger btn-xs"><i class="icon s7-search icon-sm"></i> 
		                         </a> 

		                         <a title="Edit minister" href="{{ route('individualcontribution.edit', $contribution->id) }}" class="btn btn-danger btn-xs"><i class="icon s7-pen"></i>
		                         </a>
