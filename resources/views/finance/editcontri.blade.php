...
<div class="am-content">
  <div class="main-content">
   ...
   <div class="row">
     ...
     <form class="form-horizontal"  method="post" action="{{ route('contribution.update, $individualcontribution') }}">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-3 col-sm-offset-1">
       <select  class="form-control form-control-md" name="district" id="district">
        <option></option>
        <option>1</option>
      </select>
