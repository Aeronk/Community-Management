              ...
              <tr class="odd gradeX">
                ...
                <td>{{$minister->home_tel}} </td>
                  ...
                  <td>
                         ...
                         href="{{ route('minister.show', $minister->id) }}" class="btn btn-danger btn-xs"><i class="icon s7-search icon-sm"></i> 
                         </a> 

                         <a title="Edit minister" href="{{ route('minister.edit', $minister->id) }}" class="btn btn-danger btn-xs"><i class="icon s7-pen"></i>
                         </a>
