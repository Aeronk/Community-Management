            ...
            <table id="table5" class="table table-striped table-hover table-fw-widget display" style="padding:3px">
                ...
                @foreach($denominations as $denomination)
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            <a title="View More  denomination Info"
                               href="{{ route('denomination.show', $denomination->id) }}"
                               class="btn btn-success btn-xs"><i class="icon s7-search icon-sm"></i>
                            </a>

                            <a title="Edit denomination" href="{{ route('denomination.edit', $denomination->id) }}"
                               class="btn btn-warning btn-xs"><i class="icon s7-pen"></i>
                            </a>

                            <a title="Deregister denomination" data-method="DELETE"
                               href="{{ route('denomination.destroy', $denomination->id) }}"
                               class="btn btn-danger btn-xs"><i class="icon s7-trash"></i>
                            </a>
