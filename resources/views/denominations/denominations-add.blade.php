            ...
            <div id="hod" class="panel-collapse collapse in">
              <div class="panel-body" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <label class="radio-inline"><input type="radio"  value="HOD" name="hod_or_rep">HOD</label>
                    <label class="radio-inline"><input type="radio"  value="Representative" name="hod_or_rep">Representative</label>
