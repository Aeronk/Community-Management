...
<div class="am-content">
  <div class="main-content">
        ...
        <form class="form-horizontal" method="post" action="{{ route('parachurch.store') }}">
            ...
            <div class="panel panel-danger">
              <div class="panel-heading" style= 'padding:10px'>
                <h4 class="panel-title"  style="text-align:left">
                  <a href="#basicinfo" id="BasicInfor" style = 'font-family:serif;font-size:17px' data-toggle="collapse" data-parent="accordion">Para Church /Institution Information</a>
                </h4>
              </div>
            </div>
            ...
            <div id="basicinfo" class="collapse in">
              <div class="panel-body" >
                ...
                <div class="form-group">
                  <label for="dname" class="col-sm-2 control-label" style="text-align:left"><strong>Name of the Organisation</strong><i style="color:red" class="iglyphicon glyphicon-asterisk"></i></label>
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" id="name" style="border-radius:10px " name="name" value="{{ old('name') }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                     ...
                     <input type="text" class="form-control" style="border-radius:10px " name="contact_person" id="mobile" placeholder="Contact Person" value="{{ old('contact_person') }}">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                     ...
                     <input type="text" class="form-control" style="border-radius:10px " name="mobile" id="mobile" placeholder="Mobile" value="{{ old('mobile') }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="number_of_branches" value="{{ old('number_of_branches') }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="emal" class="form-control"  style="border-radius:10px " name="email" placeholder="Email" value="{{ old('countries_spread') }}">
                    @if ($errors->has('email'))
                    <span class="invalid-feedback">
                ...
                <div class="form-group">
                  <label for="hq_address" class="col-sm-2 control-label" style="text-align:left"><strong>Headquarters Address</strong><i style="color:red" class="iglyphicon glyphicon-asterisk"></i></label>
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" id="hq" style="border-radius:10px " name="address" placeholder="Physical Address" value="{{ old('address') }}">
                    @if ($errors->has('year'))
                    <span class="invalid-feedback">
