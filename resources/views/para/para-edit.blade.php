  ...
  <div class="main-content">
    <div class="container">
      <div class="row">
        ...
        <form class="form-horizontal" method="post" action="{{ route('parachurch.update', $parachurch->id) }}">
            ...
            <div class="panel panel-danger">
              <div class="panel-heading" style= 'padding:10px'>
                <h4 class="panel-title"  style="text-align:left">
                  <a href="#basicinfo" id="BasicInfor" style = 'font-family:serif;font-size:17px' data-toggle="collapse" data-parent="accordion">parachurch Information</a>
                </h4>
              </div>
            </div>
            ...
            <div id="basicinfo" class="collapse in">
              <div class="panel-body" >
                ...
                <div class="form-group">
                  <label for="dname" class="col-sm-2 control-label" style="text-align:left"><strong>Para Church Name</strong><i style="color:red" class="iglyphicon glyphicon-asterisk"></i></label>
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" id="name" style="border-radius:10px " name="name" placeholder="Parachurch Name" value="{{$parachurch->name}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" id="year" style="border-radius:10px " name="year" placeholder="Year of Founding" value="{{ $parachurch->year_found }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="number_of_branches" placeholder="Number of Branches" value="{{ $parachurch->number_of_branches }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="number_of_members" placeholder="Number of Members" value="{{ $parachurch->number_of_members }}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" id="hq" style="border-radius:10px " name="hq_address" placeholder="HQ Physical Address" value="{{ $parachurch->hq_address}}">
                    @if ($errors->has('year'))
                    <span class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="sub_balance" placeholder="Subscription Balance" value="{{ $parachurch->sub_balance}}">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                   <select class="form-control" style="border-radius:10px " name="category">
                    ...
                    @foreach($categories as $category)
                        ...
                        <option {{$parachurch->category == $category->name ? "selected" : "" }}>{{$category->name}}</option>
                    @endforeach
              ...
              <div class="panel-body" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    ...
                    <select class="form-control" name="title" style="border-radius:10px " value="{{ $parachurch->hod->title}}">

                      <option>Please Select</option>
                      <option {{$parachurch->hod->title =='Mr' ? "selected" : "" }}>Mr</option>
                      <option {{$parachurch->hod->title =='Mrs' ? "selected" : "" }}>Mrs</option>
                     <option {{$parachurch->hod->title =='Miss' ? "selected" : "" }}>Miss</option>
                    </select>
                    @if ($errors->has('title'))
                    <span class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="first_name" placeholder="First Name" value="{{ $parachurch->hod->first_name}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="last_name" placeholder="Last Name" value="{{ $parachurch->hod->last_name}}">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control"  style="border-radius:10px " name="home_tel" placeholder=" Home Tel" value="{{ $parachurch->hod->home_tel}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="email" class="form-control" id="email" style="border-radius:10px " name="email" placeholder="Email" value="{{ $parachurch->hod->email}}">
                    @if ($errors->has('email'))
                    <span class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <label class="radio-inline"><input type="radio"  value="Single" name="marital_status" {{$parachurch->hod->marital_status =='Single' ? "checked" : "" }}>Single</label>
                    <label class="radio-inline"><input type="radio"  value="Married" name="marital_status" {{$parachurch->hod->marital_status =='Married' ? "checked" : "" }}>Married</label>
                    <label class="radio-inline"><input type="radio"  value="Divorced" name="marital_status" {{$parachurch->hod->marital_status =='Divorced' ? "checked" : "" }}>Divorced</label> 
                    <label class="radio-inline"><input type="radio"  value="Single Parent" name="marital_status" {{$parachurch->hod->marital_status =='Single Parent' ? "checked" : "" }}>Single Parent</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <label class="radio-inline"><input type="radio"  value="Male" name="gender" {{$parachurch->hod->gender =='Male' ? "checked" : "" }}>Male</label>
                    <label class="radio-inline"><input type="radio"  value="Female" name="gender" {{$parachurch->hod->gender =="Female" ? "checked" : "" }}>Female</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <label class="radio-inline"><input type="radio"  value="Yes" name="hod_or_rep" {{$parachurch->hod->hod_or_rep == 'Yes' ? 'checked' : '' }}>Yes</label>
                    <label class="radio-inline"><input type="radio"  value="No" name="hod_or_rep" {{ $parachurch->hod->hod_or_rep == 'No' ? 'checked' : '' }}>No</label>
            ...
            <div id="KeyContact" class="panel-collapse collapse in">
              <div class="panel-body" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " name="fafullname" placeholder=" Full Name" value="{{ $parachurch->contact->fafullname}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control"  style="border-radius:10px " name="facontact_number" placeholder=" Contact Number" value="{{ $parachurch->contact->facontact_number}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="email" class="form-control" id="email" style="border-radius:10px " name="faemail" placeholder="Email" value="{{ $parachurch->contact->faemail}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" style="border-radius:10px " value="{{ $parachurch->contact->wfullname}}" name="wfullname" placeholder=" Full Name">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control" value="{{ $parachurch->contact->wcontact_number}}" style="border-radius:10px " name="wcontact_number" placeholder=" Contact Number">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="email" class="form-control" id="email" value="{{ $parachurch->contact->wemail}}" style="border-radius:10px " name="wemail" placeholder="Email">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="text" class="form-control"  style="border-radius:10px " value="{{ $parachurch->contact->ycontact_number}}" name="ycontact_number" placeholder=" Contact Number">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-sm-offset-1">
                    <input type="email" class="form-control" style="border-radius:10px " {{ $parachurch->contact->yemail}} name="yemail" placeholder="Email">
