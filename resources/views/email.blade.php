...
<form class="form-horizontal group-border-dashed" id="form_register" method="post" action="send_sms_save.php" enctype="multipart/form-data" novalidate="">
			...
			<div class="panel panel-danger">
					...
					<h4 class="panel-title" style="text-align:left">
						<a href="#basic" id="BasicInfor" style="font-family:serif;font-size:17px" data-toggle="collapse" data-parent="accordion">New Email</a>
					</h4>
				</div>
						  ...
						  <label for="contType" class="col-sm-2 control-label" style="text-align:left">Message Type<i style="color:red" class="iglyphicon glyphicon-asterisk"></i></label>
							<div class="col-sm-3 col-sm-offset-1">
							  ...
							  <option value="" selected="selected">Please Select</option>
														...
														<option value="2">Local Assembly SMS							</option>
														<option value="3">Address Book SMS							</option>
														<option value="4">Stakeholder Grouping							</option>
														<option value="5">Position in Assembly							</option>
														<option value="6">Marital Status							</option>
														<option value="7">Economic Status							</option>
														<option value="11">Status							</option>
														<option value="12">Cell Group							</option>
														<option value="13">Department							</option>
														<option value="14">Gift							</option>
														<option value="15">Profession							</option>
														<option value="16">Gender							</option>
														<option value="17">All Visitors							</option>
														<option value="18">Visitors Way Forward							</option>
														<option value="19">All Members							</option>
														<option value="22">Anniversary Message							</option>
